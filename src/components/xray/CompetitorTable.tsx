    ...
    <div className="rounded-[12px] border border-[#1F2937] bg-[#111827] p-5">
      <div className="mb-4 flex items-center justify-between">
        ...
        <div className="flex items-center gap-3">
          {first_mover && (
            <span className="inline-flex items-center gap-1 rounded-full bg-amber-500/15 px-2.5 py-0.5 text-xs font-medium text-amber-400 ring-1 ring-inset ring-amber-500/20">
              <svg
                className="h-3 w-3"
                viewBox="0 0 20 20"
                fill="currentColor"
        ...
        <table className="w-full text-left text-sm">
          <thead>
            <tr className="border-b border-[#1F2937]">
              <th className="pb-2 pr-4 text-xs font-medium uppercase tracking-wide text-[#6B7280]">
                Provider
              </th>
              <th className="pb-2 pr-4 text-xs font-medium uppercase tracking-wide text-[#6B7280]">
                Serves Model
              ...
              <th className="pb-2 text-xs font-medium uppercase tracking-wide text-[#6B7280]">
                Cerebras Adv.
              </th>
            </tr>
          </thead>
              ...
              return (
                <tr
                  ...
                  className={
                    isCerebras
                      ? 'bg-indigo-500/8'
                      : 'transition-colors hover:bg-[#1F2937]/30'
                  }
                >
                  <td className="py-2.5 pr-4">
                    <span
                      className={`flex items-center gap-2 font-medium ${
                        isCerebras ? 'text-indigo-400' : 'text-[#F9FAFB]'
                      }`}
                    >
                      {isCerebras && (
                  ...
                  <td className="py-2.5 pr-4 font-mono text-[#F9FAFB]">
      ...
      {/* Summary strip */}
      <div className="mt-4 flex flex-wrap items-center gap-4 rounded-lg border border-[#1F2937] bg-[#0B0F19] px-4 py-3">
        <div className="flex items-center gap-2 text-xs">
          <span className="text-[#9CA3AF]">On Cerebras:</span>
          {on_cerebras ? (
            <span className="font-medium text-emerald-400">{'\u2713'} Available</span>
          ) : (
            <span className="font-medium text-amber-400">Not yet</span>
          )}
        </div>
        <div className="h-4 w-px bg-[#1F2937]" />
        <div className="flex items-center gap-2 text-xs">
          <span className="text-[#9CA3AF]">Speed multiplier:</span>
        ...
        <div className="h-4 w-px bg-[#1F2937]" />
        <div className="flex items-center gap-2 text-xs">
          <span className="text-[#9CA3AF]">Competitors serving:</span>
          <span className="font-mono font-semibold text-[#F9FAFB]">
